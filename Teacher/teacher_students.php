...
<body>
  ...
  <div class="dashboard-container">
    ...
    <aside class="sidebar">
      <div class="menu">
        ...
        <a href="<?= $base_url ?>Teacher/teacher_students.php" class="active"><img src="<?= $base_url ?>assets/User.png" alt="">Students</a>
        <a href="<?= $base_url ?>Teacher/teacher_files.php"><img src="<?= $base_url ?>assets/google-docs.png" alt="">Files</a>
      </div>
        ...
        <div class="section-header">
          <div class="title-group">
            ...
            <div class="search-box">
              <input type="text" id="teacherStudentSearchInput" placeholder="Search students...">
              <button id="teacherStudentSearchClear" class="clear-btn" aria-label="Clear search" title="Clear">✖</button>
            </div>
          </div>
        </div>
  ...
  <!-- Grades modal (shows Q1-Q4 and Final) -->
